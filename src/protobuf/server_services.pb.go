...
type FileCfg struct {
	...
	FileVersion    int32  `protobuf:"varint,3,opt,name=file_version,json=fileVersion" json:"file_version,omitempty"`
}
...
func (c *serverServicesClient) DeleteFile(ctx context.Context, in *StringMessage, opts ...grpc.CallOption) (*IntMessage, error) {
	out := new(IntMessage)
	err := grpc.Invoke(ctx, "/serverservices.ServerServices/DeleteFile", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
